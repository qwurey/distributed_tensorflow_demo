...
n_hidden_1 = 600 # 1st layer number of features
n_hidden_2 = 400 # 2nd layer number of features
n_hidden_3 = 300 # 3nd layer number of features
n_hidden_4 = 200 # 4nd layer number of features
n_hidden_5 = 100 # 5nd layer number of features
n_hidden_6 = 70 # 6nd layer number of features
    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(tf.train.replica_device_setter(
            ...
            weights = {
                ...
                'out': tf.Variable(tf.random_normal([n_hidden_6, n_classes], mean=0.0, stddev=1.0/tf.sqrt(n_hidden_6*1.0),
